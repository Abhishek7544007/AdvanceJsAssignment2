...
class QueenAttack {
    constructor(queen1, queen2) {
        if (queen1[0] === queen2[0] && queen1[1] === queen2[1]) throw new Error("Queens are at the same position")
        if (queen1[0] >= 8 || queen1[0] < 0 || queen1[1] >= 8 || queen1[1] < 0) throw new Error("Queens are outside the boad")
        if (queen2[0] >= 8 || queen2[0] < 0 || queen2[1] >= 8 || queen2[1] < 0) throw new Error("Queens are outside the boad")
        this.queen1 = queen1
        this.queen2 = queen2
    }
    canAttack() {
